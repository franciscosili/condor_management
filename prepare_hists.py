...
versions_flags       = f'--sversion {args.sversion} -c {args.cversion} -H {args.hversion}'
general_path_results = mkdirp(f'samples__v{args.sversion}/results_v{args.cversion}/{args.hpath}/histograms_v{args.hversion}')
...
condor_mg.setup_contents(os.path.dirname(__file__))
# ==================================================================================================`
# ==================================================================================================`
...
condor_mg.create_scripts(extra_cmds=f'{versions_flags}')
condor_mg.save_dag()
# ==================================================================================================`
# ==================================================================================================`
